    ...
    >
      ...
      <main className="px-6 md:px-10 pb-24 max-w-6xl mx-auto">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-between gap-4 text-cream/40 text-xs uppercase tracking-[0.18em]">
          <Link
            href="/kitchen/stock"
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full border border-red-400/30 bg-red-500/15 text-red-200 hover:text-red-100 hover:border-red-400/60 hover:bg-red-500/25 transition font-bold"
          >
            <svg viewBox="0 0 24 24" className="w-4 h-4" fill="none" aria-hidden>
              <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.8" />
              <path d="M8 12h8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
            </svg>
            Gérer les ruptures (86)
          </Link>
          <Link
            href="/staff"
