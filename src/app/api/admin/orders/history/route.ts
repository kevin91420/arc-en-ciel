/**
 * GET /api/admin/orders/history?date=YYYY-MM-DD
 *
 * Mirror of /api/staff/orders/history scoped to the admin cookie. Same payload,
 * different auth surface (admin login is password-based ; staff uses PIN).
 */
